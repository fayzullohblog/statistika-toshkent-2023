...
class PdfCutDjangoViews(View):
    ...
    def get(self,request):
        ...
        if request.user.degree is  None  and request.user.first_name is None:
            return HttpResponse(f'Sizning  <b style="color:red;">Ism</b> va <b  style="color:red;">Darajangiz </b> admin panelga kirgizilmadi !!!! <br> <a href="https://64.226.66.47:8000/admin/">Admin Panelga o\'tish</a> ')
